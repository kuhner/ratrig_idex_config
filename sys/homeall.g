...
G1 H1 X-410 Y-238 F2400 ; move quickly to X and Y axis endstops and stop there (first pass)
G1 H2 X5 Y5 F9000       ; go back a few mm
G1 H1 X-410 Y-238 F600  ; move slowly to X and Y axis endstops once more (second pass)
